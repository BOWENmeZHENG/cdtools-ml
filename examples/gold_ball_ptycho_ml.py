...
class Config:
    ...
    DATA: str = 'AuBalls_700ms_30nmStep_3_6SS_filter'
...
def main():
    ...
    dataset = cdtools.datasets.Ptycho2DDataset.from_cxi(f'examples/example_data/{config.DATA}.cxi')
